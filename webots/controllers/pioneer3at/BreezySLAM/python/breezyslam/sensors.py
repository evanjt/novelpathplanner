...
class Velodyne_webots(Laser):
    '''
    A class for the Velodyne HDL-32E LiDAR within Webots
    '''
    def __init__(self, detectionMargin = 0, offsetMillimeters = 0):

        Laser.__init__(self, 4500, 5, 360, 70000, detectionMargin, offsetMillimeters)

class Hokuyo_UTM30LX(Laser):
    '''
    A class for the Hokuyo UTM-30LX
    '''
    def __init__(self, detectionMargin = 0, offsetMillimeters = 0):
    # Scan size: 1080 | 0.25 deg resolution (360deg/1440 steps = 1080)
    # Scan Hz: 40 | 25msec/scan (1000 / 25 = 40)
    # Detection angle degrees: 270 deg
    # Distance limit: 30m
        Laser.__init__(self, 1080, 40, 270, 30000, detectionMargin, offsetMillimeters)
